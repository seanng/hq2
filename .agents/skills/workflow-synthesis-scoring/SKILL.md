...
- `discovery/interviews/*` — session notes, including the owner session's **mandate** (stated win, priority domains, in the sponsor's own words) and the **annual sales/revenue baseline**
